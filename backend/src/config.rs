//! Rustle application configuration (flat struct).
//!
...
const DEFAULT_PORT: u16 = 4407;

/// Rustle application configuration.
#[derive(Clone, Debug)]
...
impl AppConfig {
    ...
    pub fn load() -> Self {
        ...
        let pin = first_nonempty_env(&["Rustle_PIN", "PIN"]).and_then(|p| {
